...
public class TestCtl4 {
    @Autowired
    private RtspToHttp rtspToHttp;

//    private Map<Integer,Process> map=new HashMap<>()1111111;

    @ResponseBody
    @RequestMapping("/ipc1d")
    public Result<Map<String, String>> ipc1x(HttpServletResponse arg1) {

        Result<Map<String, String>> result = new Result<>();
        Map<String, String> resultMap = new HashMap<>();
        resultMap.put("url", "ws://127.0.0.1:8082/pre141");
    ...
    public Result<Map<String, String>> ipc1(HttpServletResponse arg1) {
        ...
        String taskId = "";
        try {
            String ipcKey = "pre141";
            long startTime = System.currentTimeMillis();
            System.out.println("开始执行");
            String current = new SimpleDateFormat("yyyy-mm-dd hh:mm:ss").format(new Date());
            //主码流播放11111111
            String cmdStr1 = "ffmpeg  -rtsp_transport  tcp  -i  rtsp://admin:pwd235@192.168.2.141:554/Streaming/Channels/101  -q 0  -f mpegts  -codec:v  mpeg1video  -s  480x320 http://127.0.0.1:8081/supersecret/" + ipcKey;
            ...
            resultMap.put("url", "ws://127.0.0.1:8082/" + ipcKey);
            ipcKey = "pre195D12";
            //主码流播放222222222
            String cmdStr2 = "ffmpeg  -rtsp_transport  tcp  -i  rtsp://admin:pwd666@192.168.2.195:554/Streaming/Channels/1201  -q 0  -f mpegts  -codec:v  mpeg1video  -s  480x320 http://127.0.0.1:8081/supersecret/" + ipcKey;
            ...
            ipcKey = "pre195D1";
            //主码流播放333333333
            String cmdStr3 = "ffmpeg  -rtsp_transport  tcp  -i  rtsp://admin:pwd666@192.168.2.195:554/Streaming/Channels/101  -q 0  -f mpegts  -codec:v  mpeg1video  -s  480x320 http://127.0.0.1:8081/supersecret/" + ipcKey;
            ...
            ipcKey = "pre195D13";
            //主码流播放4444
            String cmdStr4 = "ffmpeg  -rtsp_transport  tcp  -i  rtsp://admin:pwd666@192.168.2.195:554/Streaming/Channels/1301  -q 0  -f mpegts  -codec:v  mpeg1video  -s  480x320 http://127.0.0.1:8081/supersecret/" + ipcKey;
...
//        arg1.setHeader("Access-Control-Allow-Origin", "*");
    ...
    @ResponseBody
    @RequestMapping("/ipc2")
    public Result<Map<String, String>> ipc2(HttpServletResponse arg1) {
        arg1.setContentType("text/json; charset=utf-8");
        arg1.setHeader("Access-Control-Allow-Origin", "*");
        closesFfmpeg(arg1);
        int i = 0;
        ...
        String taskId = "";
        try {
            String ipcKey = "pre195D2";
            long startTime = System.currentTimeMillis();
            System.out.println("开始执行");
            String current = new SimpleDateFormat("yyyy-mm-dd hh:mm:ss").format(new Date());
            //主码流播放11111111
            String cmdStr1 = "ffmpeg  -rtsp_transport  tcp  -i  rtsp://admin:pwd666@192.168.2.195:554/Streaming/Channels/201  -q 0  -f mpegts  -codec:v  mpeg1video  -s  480x320 http://127.0.0.1:8081/supersecret/" + ipcKey;
            System.out.println(current + "====cmdStr1===" + cmdStr1);
            ...
            //主码流播放222222222
            String cmdStr2 = "ffmpeg  -rtsp_transport  tcp  -i  rtsp://admin:pwd666@192.168.2.195:554/Streaming/Channels/301  -q 0  -f mpegts  -codec:v  mpeg1video  -s  480x320 http://127.0.0.1:8081/supersecret/" + ipcKey;
            System.out.println(current + "====cmdStr2===" + cmdStr2);
            resultMap.put("url1", "ws://127.0.0.1:8082/" + ipcKey);
            ipcKey = "pre195D4";
            Runtime rt2 = Runtime.getRuntime();
            ...
            //主码流播放333333333
            String cmdStr3 = "ffmpeg  -rtsp_transport  tcp  -i  rtsp://admin:pwd666@192.168.2.195:554/Streaming/Channels/401  -q 0  -f mpegts  -codec:v  mpeg1video  -s  480x320 http://127.0.0.1:8081/supersecret/" + ipcKey;
            System.out.println(current + "====cmdStr3===" + cmdStr3);
            resultMap.put("url2", "ws://127.0.0.1:8082/" + ipcKey);
            ipcKey = "pre195D5";
            Runtime rt3 = Runtime.getRuntime();
...
//            process3.waitFor();
            ...
            //主码流播放4444
            String cmdStr4 = "ffmpeg  -rtsp_transport  tcp  -i  rtsp://admin:pwd666@192.168.2.195:554/Streaming/Channels/501  -q 0  -f mpegts  -codec:v  mpeg1video  -s  480x320 http://127.0.0.1:8081/supersecret/" + ipcKey;
            System.out.println(current + "====cmdStr4===" + cmdStr4);
            resultMap.put("url3", "ws://127.0.0.1:8082/" + ipcKey);
            Runtime rt4 = Runtime.getRuntime();
            Process process4 = rt4.exec(cmdStr4);
...
//        arg1.setHeader("Access-Control-Allow-Origin", "*");
    ...
    @ResponseBody
    @RequestMapping("/ipc3")
    public Result<Map<String, String>> ipc3(HttpServletResponse arg1) {
        arg1.setContentType("text/json; charset=utf-8");
        arg1.setHeader("Access-Control-Allow-Origin", "*");
        closesFfmpeg(arg1);
        int i = 0;
...
//        System.out.println("9999999999999===");
        ...
        String taskId = "";
        try {
            String ipcKey = "pre195D6";
            long startTime = System.currentTimeMillis();
            System.out.println("开始执行");
            String current = new SimpleDateFormat("yyyy-mm-dd hh:mm:ss").format(new Date());
            //主码流播放11111111
            String cmdStr1 = "ffmpeg  -rtsp_transport  tcp  -i  rtsp://admin:pwd666@192.168.2.195:554/Streaming/Channels/601  -q 0  -f mpegts  -codec:v  mpeg1video  -s  480x320 http://127.0.0.1:8081/supersecret/" + ipcKey;
            System.out.println(current + "====cmdStr1===" + cmdStr1);
            resultMap.put("url", "ws://127.0.0.1:8082/" + ipcKey);
            ipcKey = "pre195D11";
            Runtime rt1 = Runtime.getRuntime();
            ...
            //主码流播放222222222
            String cmdStr2 = "ffmpeg  -rtsp_transport  tcp  -i  rtsp://admin:pwd666@192.168.2.195:554/Streaming/Channels/1101  -q 0  -f mpegts  -codec:v  mpeg1video  -s  480x320 http://127.0.0.1:8081/supersecret/" + ipcKey;
            System.out.println(current + "====cmdStr2===" + cmdStr2);
            resultMap.put("url1", "ws://127.0.0.1:8082/" + ipcKey);
            ipcKey = "pre195D9";
            Runtime rt2 = Runtime.getRuntime();
            ...
            //主码流播放333333333
            String cmdStr3 = "ffmpeg  -rtsp_transport  tcp  -i  rtsp://admin:pwd666@192.168.2.195:554/Streaming/Channels/901  -q 0  -f mpegts  -codec:v  mpeg1video  -s  480x320 http://127.0.0.1:8081/supersecret/" + ipcKey;
            System.out.println(current + "====cmdStr3===" + cmdStr3);
            resultMap.put("url2", "ws://127.0.0.1:8082/" + ipcKey);
            ipcKey = "pre195D10";
            Runtime rt3 = Runtime.getRuntime();
...
//            process3.waitFor();
            ...
            //主码流播放4444
            String cmdStr4 = "ffmpeg  -rtsp_transport  tcp  -i  rtsp://admin:pwd666@192.168.2.195:554/Streaming/Channels/1001  -q 0  -f mpegts  -codec:v  mpeg1video  -s  480x320 http://127.0.0.1:8081/supersecret/" + ipcKey;
            System.out.println(current + "====cmdStr4===" + cmdStr4);
            resultMap.put("url3", "ws://127.0.0.1:8082/" + ipcKey);
            Runtime rt4 = Runtime.getRuntime();
            Process process4 = rt4.exec(cmdStr4);
